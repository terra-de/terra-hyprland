...
utils.set_binds({
  -- hjkl
  { "<main-sys-h>",     dsp.window.resize({ x = -20, y = 0, relative = true }), { desc = "Resize left" } },
  { "<main-sys-l>",     dsp.window.resize({ x = 20, y = 0, relative = true }),  { desc = "Resize right" } },
  { "<main-sys-j>",     dsp.window.resize({ x = 0, y = 20, relative = true }),  { desc = "Resize down" } },
  { "<main-sys-k>",     dsp.window.resize({ x = 0, y = -20, relative = true }), { desc = "Resize up" } },

  -- Arrow keys
  { "<main-sys-left>",  dsp.window.resize({ x = -20, y = 0, relative = true }), { desc = "Resize left" } },
  { "<main-sys-right>", dsp.window.resize({ x = 20, y = 0, relative = true }),  { desc = "Resize right" } },
  { "<main-sys-down>",  dsp.window.resize({ x = 0, y = 20, relative = true }),  { desc = "Resize down" } },
  { "<main-sys-up>",    dsp.window.resize({ x = 0, y = -20, relative = true }), { desc = "Resize up" } },
})
